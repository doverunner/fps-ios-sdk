...
/// public func prepare(urlAsset: AVURLAsset, contentId: String, licenseUrl: String, appleCertUrl: String)
///
/// \endcode\param urlAsset AVURLAsset  of content(m3u8).
///
/// \param userId If <code>userId</code>is not set, <code>token</code> must be set.
/// Default is <code>Empty String</code>.
///
/// \param contentId ID of content to be downloaded.
///
/// \param token If <code>token</code>is not set, <code>userId</code> must be set.
/// if both <code>userId</code> and <code>token</code> are set, the <code>token</code> takes precedence.
/// Default is <code>Empty String</code>.
///
/// \param licenseUrl License Request URL. Default is <code>Empty String</code>.
///
/// \param appleCertUrl URL to receive the cert certificate issued by Apple. Default is <code>Empty String</code>.
///
/// \param downloadOptions download the m3u8 bandwith(option).
/// You must enter a value greater than the bandwidth you want to download.
/// Defaults to an <code>Empty String</code> and the highest bandwidth is downloaded.
///
/// \param isCelluraAccess Whether to allow URLSession Cellura Access. Default is <code>True</code>.
///
/// \param downloadDelegate Registers callback for download delegate. This callback is required to get content download status.
///
///
...
/// \param url URL of content to be downloaded. (HLS m3u8 URL)
///
/// \param userId If there is a <code>token</code> value, <code>userId</code> is not used.
/// Default is <code>Empty String</code>.
///
/// \param contentId ID of content to be downloaded.
///
/// \param optionalId ID of content purchase information. This parameter is optional.
/// If there is a <code>token</code> value, <code>optionalId</code> is not used.
/// Default is <code>Empty String</code>.
///
/// \param token If <code>token</code>is not set, <code>userId</code>and <code>optionalId</code> are used.
/// if both <code>userId</code> and <code>token</code> are set, the <code>token</code> takes precedence.
/// Default is <code>Empty String</code>.
///
/// \param licenseUrl License Request URL. Default is <code>Empty String</code>.
...
/// \param isCelluraAccess Whether to allow URLSession Cellura Access. Default is <code>True</code>.
///
/// \param isAVAssetDownloadTask Download the content using <code>AVAssetDownloadTask</code>.,
///
/// \param downloadDelegate Registers callback for download delegate. This callback is required to get content download status.
///
///
/// returns:
/// A <code>DownloadTask</code> created with <code>AVAssetDownloadTask</code> is returned.
- (DownloadTask * _Nonnull)createDownloadTaskWithUrl:(NSURL * _Nonnull)url userId:(NSString * _Nonnull)userId contentId:(NSString * _Nonnull)contentId optionalId:(NSString * _Nonnull)optionalId token:(NSString * _Nonnull)token licenseUrl:(NSString * _Nonnull)licenseUrl appleCertUrl:(NSString * _Nonnull)appleCertUrl downloadOptions:(NSString * _Nonnull)downloadOptions isCelluraAccess:(BOOL)isCelluraAccess isAVAssetDownloadTask:(BOOL)isAVAssetDownloadTask downloadDelegate:(id <PallyConFPSDownloadDelegate> _Nullable)downloadDelegate SWIFT_WARN_UNUSED_RESULT SWIFT_AVAILABILITY(ios,introduced=11.0);
/// Create DownloadTask with AVAssetDownloadTask or AVAggregateAssetDownloadTask.
/// \param urlAsset AVURLAsset  of content(m3u8).
///
/// \param userId If there is a <code>token</code> value, <code>userId</code> is not used.
/// Default is <code>Empty String</code>.
///
/// \param contentId ID of content to be downloaded.
///
/// \param token PallyCon Token String.
///
/// \param licenseUrl License Request URL. Default is <code>Empty String</code>.
///
/// \param appleCertUrl URL to receive the cert certificate issued by Apple. Default is <code>Empty String</code>.
...
/// \param contentId ID of content to be downloaded.
///
/// \param contentKeyIDList Key ID value in EXT-X-KEY tag in m3u8 file.
///
/// \param token PallyCon Token String.
///
/// \param licenseUrl License Request URL. Default is <code>Empty String</code>.
